...
## 5a. Business Process Model (BPMN)

A formal BPMN swimlane model of the full order-to-decision process, showing the Customer, POS & MySQL system, Power BI/Power Query system, and Store Manager as separate lanes, including the staffing/inventory decision gateway.

![BPMN diagram of the pizza sales order-to-decision process](pizza_bpmn_diagram.svg)

**Legend:** teal = automated/system-driven step · gray = human actor or neutral outcome · amber = decision gateway.
